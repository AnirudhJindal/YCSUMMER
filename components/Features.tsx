      ...
      <motion.div style={{ y: isMounted ? y : 0 }}>
        <div style={{ maxWidth: 1152, margin: "0 auto", padding: "96px 32px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80 }}>
            ...
            {/* LEFT */}
            <div>
              <h2 style={{ fontSize: "clamp(36px, 5vw, 60px)", marginBottom: 24 }}>
                What the model<br />
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ position: "relative", background: "#faf9f6", padding: "20px 24px", borderRadius: 12 }}>
                ...
                <p style={{ fontSize: 11, color: "#78716c", marginBottom: 16, fontFamily: "monospace" }}>
              ...
              <div style={{ position: "relative", background: "#f0fdf4", padding: "20px 24px", borderRadius: 12 }}>
                ...
                <p style={{ fontSize: 11, color: "#16a34a", marginBottom: 16, fontFamily: "monospace" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                {["0 bytes", "<2 ms", "any LLM"].map((s, i) => (
                  <motion.div
                    ...
                    style={{ padding: 12, background: "#faf9f6", textAlign: "center" }}
                  >
                    {s}
                  </motion.div>
                ))}
